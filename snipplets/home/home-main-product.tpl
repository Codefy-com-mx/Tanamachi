		...
		<section id="single-product" class="js-product-container section-main-product-home" data-variants="{{product.variants_object | json_encode }}" data-store="home-product-main">
			<div class="container-fluid px-0">
				<div class="row m-0 no-gutters align-items-center">
					<div class="col-md-5 col-lg-4 order-2 order-md-1 mb-4 mb-md-0 px-4 px-md-4" data-store="product-info-{{ product.id }}">
					...
					<div class="col-md-7 col-lg-8 order-1 order-md-2 pb-3 pr-md-0 mb-4 mb-md-0 js-main-product-image-col">
